...
export const books: Book[] = [
    {
        ...
        coverImage: '/images/pigs/cover.png',
        scenes: [
            {
                id: 'scene-1',
                storyText: '從前有三隻小豬，因為長大了，豬媽媽叫他們要搬出去自己住。',
                imageUrl: '/images/pigs/scene1.png',
                question: {
                    id: 'q1',
                    text: '為什麼豬媽媽要三隻小豬搬出去？',
                    options: [
            ...
            // Placeholder for other 5 scenes
            {
                ...
                imageUrl: '/images/pigs/scene2.png',
            },
            {
                id: 'scene-3',
                storyText: '豬二哥也很貪玩，用木頭蓋了一間房子。',
                imageUrl: '/images/pigs/scene3.png',
            },
            {
                id: 'scene-4',
                storyText: '只有豬小弟很勤勞，辛苦地用磚頭蓋了一間堅固的房子。',
                imageUrl: '/images/pigs/scene4.png',
            },
            {
                id: 'scene-5',
                storyText: '大野狼來了！吹垮了稻草屋和木頭屋，小豬們嚇得躲進磚頭屋。',
                imageUrl: '/images/pigs/scene5.png',
            },
            {
                id: 'scene-6',
                storyText: '大野狼怎麼吹也吹不倒磚頭屋，最後只好灰溜溜地逃走了。',
                imageUrl: '/images/pigs/scene6.png',
            }
        ],
    },
    {
        ...
        coverImage: '/images/jack/cover.png',
        scenes: [
            {
                id: 'jack-1',
                storyText: '從前有個男孩叫傑克，他用家裡的乳牛換了一顆神奇的豆子。',
                imageUrl: '/images/jack/scene1.png',
                question: {
                    id: 'q-jack-1',
                    text: '傑克用什麼換了豆子？',
                    options: [
            ...
            },
            {
                ...
                imageUrl: '/images/jack/scene2.png'
            }
        ],
    },
    {
        ...
        coverImage: '/images/red/cover.png',
        scenes: [
            {
                id: 'red-1',
                storyText: '有一天，媽媽叫小紅帽送點心去給生病的奶奶。',
                imageUrl: '/images/red/scene1.png',
                question: {
                    id: 'q-red-1',
                    text: '小紅帽要去哪裡？',
                    options: [
    ...
    },
    {
        ...
        coverImage: '/images/duck/cover.png',
        scenes: [
            {
                id: 'duck-1',
                storyText: '鴨媽媽孵出了一隻特別大的蛋，生出了一隻長得灰灰的醜小鴨。',
                imageUrl: '/images/duck/scene1.png'
            }
        ]
    },
    {
        ...
        coverImage: '/images/race/cover.png',
        scenes: [
            {
                id: 'race-1',
                storyText: '兔子嘲笑烏龜爬得慢，於是他們決定來比賽跑步。',
                imageUrl: '/images/race/scene1.png',
                question: {
                    id: 'q-race-1',
                    text: '誰嘲笑烏龜爬得慢？',
                    options: [
